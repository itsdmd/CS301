...
import 'edit_display_name_model.dart';
export 'edit_display_name_model.dart';

class EditDisplayNameWidget extends StatefulWidget {
  const EditDisplayNameWidget({super.key});
...
class _EditDisplayNameWidgetState extends State<EditDisplayNameWidget> {
  late EditDisplayNameModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditDisplayNameModel());
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  FFLocalizations.of(context).getText(
                                    'plu7gn0q' /* Please make sure that your dis... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                      ...
                      Expanded(
                        ...
                        child: Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              if (functions.stringIsAlphaOnly(
